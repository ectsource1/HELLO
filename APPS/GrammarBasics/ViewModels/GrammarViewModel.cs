...
namespace GrammarBasics.ViewModels
{
    ...
    public class GrammarViewModel : BindableBase, INavigationAware
    {
        ...
        public GrammarViewModel(ITTService ttsService)
        {
        ...
        private void Save()
        {
            File.WriteAllText(textDocument.FileName, editBox.GetPlainText());
        }
        ...
        void INavigationAware.OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            if (textId.HasValue)
            {
                TextDocument temp = this.ttsService.GetGrammarDocument(textId.Value);
